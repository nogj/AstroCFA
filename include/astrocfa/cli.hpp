...
inline void print_cli_help(std::ostream &out, std::string_view executable) {
  out << "AstroCFA " << version << "\n"
      ...
      << "  " << executable
      << " develop <input-raw-or-dng> [--bias master.dng|--bias-dir dir] [--dark master.dng|--dark-dir dir] [--flat master.dng|--flat-dir dir] [--dark-excludes-bias] [--no-cosmetic-correction] [--method bilinear-baseline|malvar-baseline|residual-interpolation|frequency-guided|inverse-refine] [--background off|gradient|neutral] [--background-tile pixels] [--background-degree 0..2] [--white-balance auto|as-shot|daylight|unity] [--wb-multipliers r,g,b] [--output-space auto|srgb|camera] [--tone none|linear|arcsinh|ghs] [--exposure-ev v] [--black-point v --white-point v] [--stretch-factor v] [--local-intensity v] [--symmetry-point v] [--protect-shadows v] [--protect-highlights v] [--saturation v] [-o output.tif|jpg] [--preview-stretch none|astro] [--jpeg-quality 1..100] [--inverse-iterations n] [--chroma-smoothness v] [--alias-suppression v] [--edge-sensitivity v] [--star-chroma-guard v] [--star-luma-threshold v] [--export-background map.tif|jpg] [--export-alias-risk map.tif|jpg] [--export-residual-map map.tif|jpg] [--export-defect-map map.tif|jpg]\n"
      << "  " << executable
